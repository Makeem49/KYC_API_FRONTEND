      ...
      <Group position="center">
        <Tooltip label="Transaction by Location" className="p-3">
          <button
            ...
            className="hidden md:flex w-full items-center gap-2 py-2 px-3 hover:bg-afexpurple-regular hover:shadow text-white text-[14px] bg-afexpurple-regular rounded-lg">
