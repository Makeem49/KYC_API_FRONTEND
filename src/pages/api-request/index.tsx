...
const ApiRequest = () => {
  ...
  return (
    <div className="w-full h-screen  overflow-y-auto flex">
      <div className="w-full h-screen flex flex-col gap-14 overflow-y-auto md:p-10">
        {/* Title */}
        <div className="flex w-full justify-between items-center">
          ...
          <div
            ...
            <button className="flex w-full items-center md:gap-4 py-2 px-3 hover:bg-afexpurple-lighter hover:shadow text-afexpurple text-[14px] bg-afexpurple-lighter dark:bg-afexdark-darkest rounded-lg">
              <span className="w-full text-[10px] md:text-[14px]">
                {t('GENERATE API KEY')}
              </span>
