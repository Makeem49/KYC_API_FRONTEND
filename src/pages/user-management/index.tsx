                  ...
                  <ul
                    ...
                    {providersArray?.providers?.map((el: any, index: any) => (
                      <span
                        ...
                        className='flex w-full hover:bg-afexpurple-lighter rounded-lg whitespace-nowrap text-gray-900 dark:text-afexdark-regular text-base cursor-pointer m-1 py-2 px-2 capitalize'>
                        {' '}
                        {el.name}
                      </span>
                    ))}
