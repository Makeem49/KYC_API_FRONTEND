    ...
    <div className='gap-1 flex flex-col'>
      ...
      <div className='relative w-full'>
        <input
          ...
          className='block w-full appearance-none outline-none tracking-wide rounded-lg text-sm p-3 font-normal text-textgrey-darker bg-white h-14 border focus:border-afexred-light transition '
          {...field}
        />
