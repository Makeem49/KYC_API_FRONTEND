  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className={`block w-full appearance-none outline-none bg-white tracking-wider rounded-lg ring-1 ring-[#DAD9DA]  focus:ring-2 h-16 xl:h-16 transition duration-150 py-3 px-4 ${inputClass} `}
